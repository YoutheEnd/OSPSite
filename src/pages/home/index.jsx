...
class Home extends Language {
    ...
    componentDidMount() {
        ...
        fetch("https://api.github.com/repos/rpa-ai/RPAStudio",{method: "GET"})
            .then(res => res.json())
            .then((data) => {
                this.setState({
                ...
                <section className="top-section">
                    ...
                    <div className="vertical-middle">
                        ...
                        <div className="github-buttons">
                            <a href="https://github.com/rpa-ai/RPAStudio" target="_blank" rel="noopener noreferrer">
                                <div className="star">
                                    <img src={getLink(dataSource.brand.starImg)} />
                                    <span>{this.state.stargazers_count}</span>
                                </div>
                            </a>
                            <a href="https://github.com/rpa-ai/RPAStudio/fork" target="_blank" rel="noopener noreferrer">
                                <div className="fork">
                                    <img src={getLink(dataSource.brand.forkImg)} />
                                    <span>{this.state.forks_count}</span>
                                </div>
                            </a>
                        </div>
                    </div>
